...
public class CosmosPlayedGameService : ICosmosPlayedGameService
{
    private readonly ILogger<CosmosPlayedGameService> _logger;
    private readonly GameContextCosmos _context;
    public CosmosPlayedGameService(ILogger<CosmosPlayedGameService> logger, GameContextCosmos context)
    {
